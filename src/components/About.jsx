        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className={`md:w-1/2 md:pl-12 my-8 ${darkMode ? 'text-white' : 'text-black'}`}>
            ...
            <div data-aos="fade-right" >
              ...
              <p className="mb-4" data-aos="zoom-in">A continuación algunas de mis redes sociales en donde me puedes encontrar:</p>
            </div>
            <div className="flex mt-4 gap-4" data-aos="zoom-in-down">
              <a href="" target="_blank" rel="noopener noreferrer" className="mr-2 hover:scale-125 duration-500 hover:drop-shadow-xl" aria-label="LinkedIn">
                <FaLinkedin className="w-8 h-8 hover:text-primary" />
              </a>
              <a href="" target="_blank" rel="noopener noreferrer" className="mr-2 hover:scale-125 duration-500 hover:drop-shadow-xl" aria-label="GitHub">
                <FaGithub className="w-8 h-8 hover:text-primary" />
              </a>
              <a href="" target="_blank" rel="noopener noreferrer" className="mr-2 hover:scale-125 duration-500 hover:drop-shadow-xl" aria-label="Flickr">
                <FaFlickr className="w-8 h-8 hover:text-primary" />
              </a>
              <a href="" target="_blank" rel="noopener noreferrer" className='hover:scale-125 duration-500 hover:drop-shadow-xl' aria-label="Instagram">
